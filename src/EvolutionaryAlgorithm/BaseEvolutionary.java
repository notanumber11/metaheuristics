...
public class BaseEvolutionary {
    ...
    private Utilities.Timer timer = new Utilities.Timer();


    public BaseEvolutionary(String distancesPath){
        // Loading the distance matrix
        m_Distances = new Distances(distancesPath);
    ...
    public void start(){
        ...
        PrinterEvolutionary.printBestIteration(bestSolutionEver, bestIterationEver);
        timer.end();
    }
    ...
    public void binaryTournament(){
        ...
        for(int i = 0; i < numberOfIndividuals - sizeOfElitism; i++){
            ...
            PrinterEvolutionary.printTournament(i, number1, number2, winner);
        }
        System.out.println();
    }
    ...
    public void orderCrossover(){
        ...
        for(int i = 0; i < (numberOfIndividuals- sizeOfElitism)-1 ; i+=2){
            ...
            PrinterEvolutionary.printWay("RECORRIDO: ",citys1);
            System.out.println("}");
            System.out.print("\t\tPADRE: = {FUNCION OBJETIVO (km): "+citys2.getCost()+", ");
            PrinterEvolutionary.printWay("RECORRIDO: ",citys2);
            System.out.println("}");
    ...
    public void mutation(){
        ...
        for(int i = 0; i < numberOfIndividuals- sizeOfElitism; i++){
            ...
            PrinterEvolutionary.printWay("\tRECORRIDO ANTES: " ,citys);
            System.out.println();
            ...
            PrinterEvolutionary.printWay("\tRECORRIDO DESPUES: " ,citys);
            System.out.println("");
            System.out.println("");
        }
        System.out.println();
