...
public class Practica2 {
    ...
    public Practica2(Solution solution){
    ...
    public void startPractica2(){
        Utilities.initPrint(m_Solution);
        ...
        while(iterationNumber<numberOfIterations){
            if(iterationsWithoutImprove==tenencia){
                ...
                resetNumber++;
              //  tabuList.clear();
                Utilities.printReset(resetNumber);
            }
            generateIteration();
        }
        getLastSolution();
        Utilities.printFinalSolution(m_Solution,bestIteration);
      //  Utilities.printMatriz(m_ExplorerPath);
    }
    ...
    public void generateIteration(){
       ...
       // Utilities.printTabu(tabuList);
        Utilities.printIteration(m_Solution,iterationNumber,finalPosX,finalPosY,iterationsWithoutImprove, tabuList);
