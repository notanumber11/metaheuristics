...
public class Practica3 {
    ...
    public double enfriamientoCauchy(){
        ...
        OldPrinter.printEnfriamiento(this);
        return temperature;
    }

    public Practica3(Solution solution){
        //Init solution
    ...
    public void startPractica3(){
        temperature = calculateInitTemperature();
        OldPrinter.initPrint(this);
        ...
        double actualRandom = 0;
            ...
            for(iteration = 0; iteration < stopCritery ; iteration++){
                ...
                numeroCandidatas++;
                OldPrinter.printIteracion(this);
            ...
            OldPrinter.printBestSolution(this);
      //  OldPrinter.printMatriz(m_ExplorerPath);
    }
